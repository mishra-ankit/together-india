    ...
    */
    head: {
        ...
        meta: [
            ...
            {property: 'og:url', content: 'https://together-india.com/'},
            ...
            {property: 'og:image', content: 'https://together-india.com/social.png'},
            {property: 'twitter:card', content: 'summary_large_image'},
            {property: 'twitter:url', content: 'https://together-india.com/'},
            ...
            {property: 'twitter:image', content: 'https://together-india.com/social.png'},
        ],
        link: [
